          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 shadow-2xl">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Sign in to continue your SkillForge journey.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-white/10 bg-white/5 py-3 pl-10 pr-4 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-white/30"
                  />
                </div>
              </div>
